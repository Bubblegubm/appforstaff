...
class Ui_Authorization(object):
    def setupUi(self, Authorization):
        ...
        Authorization.setStyleSheet(u"background-color: qlineargradient(spread:pad, x1:0.358, y1:0.266636, x2:1, y2:1, stop:0 rgba(163, 5, 255, 255), stop:1 rgba(92, 51, 255, 255))")
...
"background-color: rgba(0, 0, 0, 100);")
    ...
    def retranslateUi(self, Authorization):
        ...
        self.Login.setText("")
        self.Login.setPlaceholderText(QCoreApplication.translate("Authorization", u"\u041b\u043e\u0433\u0438\u043d", None))
        self.ButtonAuthorization.setText(QCoreApplication.translate("Authorization", u"\u0412\u0445\u043e\u0434", None))
        self.ButtonRegistration.setText(QCoreApplication.translate("Authorization", u"\u0420\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u044f", None))
        self.Password.setText("")
        self.Password.setPlaceholderText(QCoreApplication.translate("Authorization", u"\u041f\u0430\u0440\u043e\u043b\u044c", None))
        self.ButtonProblemsWithAuthorization.setText(QCoreApplication.translate("Authorization", u"\u041f\u0440\u043e\u0431\u043b\u0435\u043c\u044b \u0441\u043e \u0432\u0445\u043e\u0434\u043e\u043c", None))
        self.LableAuthorization.setText(QCoreApplication.translate("Authorization", u"\u0410\u0432\u0442\u043e\u0440\u0438\u0437\u0430\u0446\u0438\u044f", None))
